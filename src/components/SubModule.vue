<template>
  <li style="display: flex; align-items: center">
    <RouterLink
      :to="{ name: 'Module', params: { module: module.slug, subModule: subModule.slug } }"
      class=""
    >
      ...
      <div v-else>
        ...
        <div style="display: flex" v-else>
          ...
          <div
            ...
            v-if="$route.params.subModule == subModule.slug"
          >
            <a
              href="#"
              class="edit-module-button"
              @click.prevent="editSubModule(subModule)"
            >
